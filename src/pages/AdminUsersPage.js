                ...
                onSubmit={(values, errors) => {
                    ...
                    fetch(url, {
                        ...
                        if (res.ok) {
                            ...
                            else errors.setFieldError("err", "Server side eror");
                        }
                    });
                }}
                            ...
                            <tr key={u.id}>
                                ...
                                <td style={{ width: "120px" }}>
                                    <Button
                                        ...
                                        href="#edituser"
                                        variant="link"
                                        onClick={() => handleSetUserEdit(index)}
                                    >
                                        {" "}
